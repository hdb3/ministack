...
spec = {
    ...
    'Hosts' : [
        ...
        { 'name' : "kilo-network" , 'image' : "Centos7" , 'flavor':"m1.xlarge" , 'net' : [ ("kilo" , "192.168.0.22","kilo-network"), ("kilo-dataplane"), ("kilo-provider","172.16.1.3") ] },
        { 'name' : "kilo-compute-1" , 'image' : "Centos7" , 'flavor':"m1.xlarge" , 'net' : [ ("kilo" , "192.168.0.101","kilo-compute-1"), ("kilo-dataplane"), ("kilo-provider","172.16.1.4") ] },
        { 'name' : "kilo-compute-2" , 'image' : "Centos7" , 'flavor':"m1.xlarge" , 'net' : [ ("kilo" , "192.168.0.102","kilo-compute-2"), ("kilo-dataplane"), ("kilo-provider","172.16.1.5") ] },
        { 'name' : "kilo-host" , 'image' : "Centos7" , 'flavor':"m1.medium" , 'net' : [ ("kilo" , "192.168.0.103","kilo-host"), ("kilo-provider","172.16.1.6") ] },
    ]
}
